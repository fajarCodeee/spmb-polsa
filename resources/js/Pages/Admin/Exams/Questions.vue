                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                                    v-for="(item, index) in questions.data" :key="index">
                                    <th scope="row"
                                    ...
                                    <td class="px-6 py-4 break-all w-2/3">
                                        ...
                                        <br />
                                        <span v-for="(value, key) in Object.keys(
                                            option
                                        )" :key="key" :class="{
                                            ...
                                            ">
                                                {{ value }}.
                                                <span v-html="item[option[value]]"></span><br />
                                            </span>
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                        ...
                        <div class="py-1 px-4">
                            <nav class="flex items-center space-x-1">
                                <button type="button"
                                    ...
                                    aria-current="page" v-for="link in questions.links" :key="link.label"
            ...
            <Modal :show="showModal" @close="close()">
                <div class="p-6">
                    ...
                    <form @submit.prevent="save()" class="mt-4">
                        <div class="grid grid-cols-1 gap-6" v-if="dialogIndex != 2">
                            <div>
                                <InputLabel for="question">
                                    Pertanyaan
                                </InputLabel>
                                <TextareaInput v-model="form.question">
                                </TextareaInput>
                            ...
                            <div>
                                ...
                                <Combobox v-model="form.answer" id="answer" class="mt-1 block w-full" :option-value="[
                                    {
                                        value: '',
                                        text: '--PILIH JAWABAN--',
                                    },
                            ...
                            <div>
                                ...
                                <TextareaInput v-model="form.option_a" id="option_a" class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <TextareaInput v-model="form.option_b" id="option_b" class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <TextareaInput v-model="form.option_c" id="option_c" class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <TextareaInput v-model="form.option_d" id="option_d" class="mt-1 block w-full" />
                            ...
                            <div>
                                ...
                                <TextareaInput v-model="form.option_e" id="option_e" class="mt-1 block w-full" />
                                <InputError :message="form.errors.option_e" />
                            </div>

                            <div class="flex justify-end mt-6">
                                <SecondaryButton type="button" @click="close()" class="mr-2">
                                    Batal
                                </SecondaryButton>
