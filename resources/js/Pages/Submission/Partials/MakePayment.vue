                ...
                <div class="shadow-md sm:shadow-lg p-4 sm:p-8">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="inline-flex items-center gap-x-3">
                            ...
                            <button type="button"
                                ...
                                @click="
                                    ...
                                    ">
                                <svg class="w-4 h-4 group-hover:rotate-6 transition" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="flex justify-end gap-4 mt-8">
                            ...
                            <PrimaryButton>Upload Bukti Pembayaran</PrimaryButton>
                            </Link>
                        </div>
                    </div>
                </div>
                <div class="shadow-md sm:shadow-lg p-4 sm:p-8">
                    ...
                    <div class="mt-4">
                        <ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
                            <li>
                                Apabila pembayaran melalui setor tunai ke {{ $page.props.web_settings.payment_bank }}
                                ataupun beda BANK, anda harus menuliskan
